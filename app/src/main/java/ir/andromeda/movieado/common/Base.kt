...
abstract class MovieadoFragment() : Fragment(), MovieadoView {
...
abstract class MovieadoActivity : AppCompatActivity(), MovieadoView {
    override val rootView: CoordinatorLayout?
        get() {
...
abstract class MovieadoViewModel : ViewModel() {
